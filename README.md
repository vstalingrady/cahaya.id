# caharaya - All Your Money, In One Place
...
# Demo User Credentials (for the "Skip for Demo" button)
NEXT_PUBLIC_DEMO_USER_EMAIL=demo@caharaya.app
...
We welcome contributions to this project. Please feel free to submit a pull request or open an issue if you find any bugs or have suggestions for improvements.
