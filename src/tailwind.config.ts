  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'pulsing-glow': {
          '0%, 100%': { 
            boxShadow: '0 0 25px -5px hsl(var(--primary) / 0.5), 0 0 15px -8px hsl(var(--accent) / 0.4)',
            transform: 'scale(1)',
          },
          '50%': { 
            boxShadow: '0 0 45px 0px hsl(var(--primary) / 0.6), 0 0 25px -5px hsl(var(--accent) / 0.5)',
      ...
      animation: {
        ...
        'pulsing-glow': 'pulsing-glow 6s ease-in-out infinite',
      },
    },
  },
