...
const caharaya_FEE = 500;
const TOTAL_FEE = BI_FAST_FEE + BANK_API_FEE + caharaya_FEE;
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-3 bg-secondary p-5 rounded-2xl border border-border">
                    ...
                    <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">caharaya Service Fee</span>
                    <span className="font-mono text-card-foreground">{formatCurrency(caharaya_FEE)}</span>
                    </div>
