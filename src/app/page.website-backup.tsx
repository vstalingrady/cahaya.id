...
import caharayaLogo from '@/components/icons/cuanlogo';
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 p-4 z-50 bg-background/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <caharayaLogo className="w-32 h-auto" />
        ...
        <div className="w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0">
              caharaya securely connects to all your bank and e-wallet accounts,
      ...
      <footer className="py-8 bg-background">
          <div className="max-w-7xl mx-auto px-4 text-center text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} caharaya. All Rights Reserved.</p>
          </div>
      </footer>
    </div>
  );
