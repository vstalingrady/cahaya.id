      ...
      <div className="w-full max-w-md mx-auto h-screen flex flex-col">
        ...
        >
          <div className="w-full flex justify-between items-center">
            <div className="w-32 h-auto font-bold text-2xl text-primary font-serif">caharaya</div>
        ...
        <div className="flex-1 overflow-hidden" ref={emblaRef}>
          <div className="h-full flex">
            ...
            <section className="flex-[0_0_100%] min-w-0 flex flex-col items-center justify-center px-6 pb-6 gap-4 overflow-y-auto custom-scrollbar">
                <div className="text-center space-y-4 animate-fade-in-up max-w-sm">
                    ...
                    <p className="text-base text-muted-foreground">
                        caharaya securely connects to all your accounts, giving you a complete financial overview and AI-powered insights to grow your wealth.
                    </p>
                </div>
            </section>
            ...
            {/* Slide 7: Security */}
            <section className="flex-[0_0_100%] min-w-0 flex flex-.tsxcol px-6 py-6 gap-6 overflow-y-auto custom-scrollbar">
                <div className="text-center max-w-sm mx-auto flex-shrink-0">
