...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI assistant for a personal finance app called caharaya. Your task is to generate three engaging and relevant starter questions for the user to ask you.
