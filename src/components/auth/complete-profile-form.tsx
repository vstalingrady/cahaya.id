  ...
  return (
    <div className="bg-card/50 backdrop-blur-xl p-8 rounded-2xl border border-border shadow-lg shadow-primary/10">
      <div className="space-y-4">
          <Button className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/80 h-14 text-base font-semibold gap-3 [&_svg]:size-5" type="button" onClick={handleGoogleSignIn} disabled={isSubmitting}>
              <FaGoogle />
              Continue with Google
          </Button>
          <Button className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/80 h-14 text-base font-semibold gap-3 [&_svg]:size-5" type="button" onClick={handleAppleSignIn} disabled={isSubmitting}>
              <FaApple />
              Continue with Apple
          </Button>
      </div>
