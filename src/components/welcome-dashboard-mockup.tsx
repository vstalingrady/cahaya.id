...
const mockTransactions: Transaction[] = [
  // July 2024 - A more dynamic month
  ...
  { id: 'txn_8', accountId: 'acc_mandiri_payroll_4', amount: 45000000, date: '2024-06-30', description: 'Bonus Tahunan', category: 'Income' }, // June
  ...
  // Adding more transactions for a dynamic chart
